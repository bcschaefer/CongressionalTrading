  ...
  return (
    <div className="overflow-hidden rounded-md border border-(--color-border) bg-white p-6">
      <button
        ...
        className={`flex w-full cursor-pointer items-center justify-between border border-(--color-border) bg-white px-3 py-2.5 text-left text-[13px] font-bold text-foreground ${
      ...
      >
        <div className="max-h-75 overflow-y-auto rounded-b-sm border border-t-0 border-(--color-border) p-1.5">
